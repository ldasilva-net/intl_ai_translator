...
void main() {
  group('IntlAiTranslatorCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late IntlAiTranslatorCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = IntlAiTranslatorCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = IntlAiTranslatorCommandRunner();
